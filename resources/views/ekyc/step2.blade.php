        ...
        <form action="{{ route('ekyc.storeStep2') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                ...
                @if ($data && $data->file_ktp)
                    <img src="{{ asset('storage/' . $data->file_ktp) }}" class="max-w-full h-40 object-contain rounded mt-2 border">
                @endif
            </div>
            ...
            <div>
                ...
                @if ($data && $data->file_selfie)
                    <img src="{{ asset('storage/' . $data->file_selfie) }}" class="max-w-full h-40 object-contain rounded mt-2 border">
                @endif
            </div>
