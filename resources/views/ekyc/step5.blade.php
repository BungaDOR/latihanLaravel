<x-app-layout>
    <div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow mt-8 text-center">
        ...
        @if ($data->status == 'accepted')
            <div class="bg-green-100 text-green-700 p-3 mb-4 rounded font-semibold">
                ✔️ Selamat! Registrasi eKYC Anda telah *DITERIMA*.
            </div>
        @endif
        @if ($data->status == 'rejected')
            <div class="bg-red-100 text-red-700 p-3 mb-4 rounded font-semibold">
                ❌ Maaf, registrasi eKYC Anda *DITOLAK*.  
                Silakan periksa kembali data Anda dan lakukan pengajuan ulang.
            </div>
        @endif
        @if (session('success'))
