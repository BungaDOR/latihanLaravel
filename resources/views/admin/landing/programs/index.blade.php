    ...
    <div x-data="programPage()" class="py-12">
                            ...
                            @foreach ($program as $program)
                                <tr>
                                    ...
                                    <td class="border px-4 py-2 text-center">
                                        ...
                                        <form action="{{ route('admin.landing.programs.destroy', $program->id) }}" method="POST" class="inline-block">
                                            @csrf @method('DELETE')
                                            <button type="submit"
        ...
        <div x-show="showCreate" class="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50">
            <div @click.outside="showCreate = false" x-transition
                class="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-lg w-96">

                <h2 class="text-xl text-white font-semibold mb-4">Tambah Program</h2>
                ...
                <form method="POST" action="{{ route('admin.landing.programs.store') }}" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div class="block mb-1">
                        <label class="block mb-1 text-white">Position</label>
        ...
        <div x-show="showEdit" class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
            <div @click.outside="showEdit = false" x-transition
                ...
                <h2 class="text-xl font-semibold mb-4 text-white">Edit Program</h2>

                <form method="POST" :action="'/admin/landing/programs/' + editData.id"
                    ...
                    <div class="block mb-1">
                        <label class="block mb-1 text-white">Image (ganti jika perlu)</label>
                        <input type="file" name="image" class="border-gray-300 rounded-md w-full">
