                        ...
                        <div x-data="{ open : {{ request()->is('admin/landing') ? 'true' : 'false' }} }" class="mt-2">
                            ...
                            <div x-show="open" x-transition class="pl-6 space-y-1">
                                ...
                                class="block px-4 py-2 hover:bg-gray-200
                                        {{ request()->is('admin/landing/settings') ? 'bg-gray-200 font-semibold' : '' }}">
                                    ⚙ Settings
                                </a>

                                <a href="{{ route('admin.landing.navigation.index') }}"
                                class="block px-4 py-2 hover:bg-gray-200
                                        {{ request()->is('admin/landing/navigation') ? 'bg-gray-200 font-semibold' : '' }}">
                                    🧭 Menu Navigasi
                                </a>

                                <a href="{{ route('admin.landing.programs.index') }}"
                                class="block px-4 py-2 hover:bg-gray-200
                                        {{ request()->is('admin/landing/programs') ? 'bg-gray-200 font-semibold' : '' }}">
                                    🎓 Program Studi
                                </a>

                                <a href="{{ route('admin.landing.footer.index') }}"
                                class="block px-4 py-2 hover:bg-gray-200
                                        {{ request()->is('admin/landing/footer') ? 'bg-gray-200 font-semibold' : '' }}">
                                    📑 Footer
                                </a>
